...
var AssetFemale3DCG = [
...

	{
		...
		Asset: [
			...
			{ Name: "AdultBabyHarness", Priority: 33, Value: 50, Difficulty: 3, Time: 15, RemoveTime: 10, AllowLock: true, DefaultColor: "#aaaaaa", RemoveItemOnRemove: { Name: "MittenChain1", Group: "ItemArms" }, ExpressionTrigger: [{ Name: "Low", Group: "Blush", Timer: 10 }] },
...

	{
		...
		Asset: [
			{ Name: "PaddedMittens", Value: 40, Difficulty: 4, SelfBondage: 2, Time: 15, AllowLock: true, DefaultColor: "#bbbbbb", AllowPose: ["BackBoxTie", "BackElbowTouch", "BackCuffs", "Yoked", "AllFours"], Effect: ["Block", "Prone"], Extended: true, RemoveItemOnRemove: { Name: "MittenChain1", Group: "ItemArms" } },
			{ Name: "PawMittens", Value: 50, Difficulty: 4, SelfBondage: 1, Time: 15, AllowLock: true, DefaultColor: "#bbbbbb", AllowPose: ["BackBoxTie", "BackElbowTouch", "BackCuffs", "Yoked", "AllFours"], Effect: ["Block", "Prone"], Extended: true, RemoveItemOnRemove: { Name: "MittenChain1", Group: "ItemArms" } },
